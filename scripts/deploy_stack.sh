...
echo -e "  ${WHITE}EDR Agent Swarm Mesh:${RESET}          3 Containerized Agents (vm1, vm2, vm3)"
echo ""
echo -e "${BOLD}Management Commands:${RESET}"
echo -e "  View live logs:         ${YELLOW}docker compose logs -f${RESET}"
echo -e "  Run Red Team Simulation: ${YELLOW}docker compose exec agent-vm1 python -m experiments.simulations.run_multi_node_demo --all${RESET}"
